...
- Create Angular project with ng: `ng new ECommercePlatform.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ECommercePlatform.client.esproj`).
