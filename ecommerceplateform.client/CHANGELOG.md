...
- Create Angular project with ng: `ng new ecommerceplateform.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ecommerceplateform.client.esproj`).
